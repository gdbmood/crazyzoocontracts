...
contract TestingStakingContract is CrazyZooStaking {
    ...
    function _1_testCalculateRewards(address _address, uint256 _days)
        public
    {
    ...
    function _2_testCalculateRewards(address _address, uint256 _days)
        public
    {
        for (uint256 i = 1; i < 2; i += 1) {
            StakedNft memory _stakedNft;
    ...
    function _3_testCalculateRewards(address _address, uint256 _days)
        public
    {
        for (uint256 i = 1; i < 2; i += 1) {
            StakedNft memory _stakedNft;
    ...
    function testUpdateUserPool(address _address)
        public
    {        
    ...
    //less than 30 days.
    function testSetRewardsPerDay(address _address)
        public
    {
    ...
    function testSetRewardDays(address _address)
        public
    {
        _1_testCalculateRewards(_address, 15);
    ...
    function _1_testIsHungry(address _address)
        public
    {
    ...
    function _2_testIsHungry(address _address)
        public
    {
        for (uint256 i = 0; i < 1; i += 1) {
            StakedNft memory _stakedNft;
